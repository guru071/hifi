...
/**
 * Google + Apple single sign-on buttons. On success the user is redirected to
 * Supabase's hosted OAuth, then returned to /auth/callback which enforces the
 * phone-required and disposable-domain checks.
 */
export default function OAuthButtons() {
  ...
  async function handleProvider(provider: OAuthProvider) {
    ...
    setError(null);
    try {
      const { error: oauthError } = await signInWithProvider(
        provider,
      ...
      <div className={styles.row}>
        ...
        >
          <svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true">
            ...
            <path
              fill="#FBBC05"
              d="M5.84 14.1c-.22-.66-.35-1.36-.35-2.1s.13-1.44.35-2.1V7.06H2.18A11 11 0 0 0 1 12c0 1.77.43 3.45 1.18 4.94l2.85-2.22.81-.62z"
            />
            <path
              fill="#EA4335"
